...
namespace Tik4Net.Objects.Ip.Firewall
{
    ...
    /// </summary>
    [TikEntity("/ip/firewall/filter", TikEntityEditMode.Editable, Tik4Net.Connector.ExecuteReaderBehaviors.None)]    
    public sealed partial class FirewallFilter: TikEntityBase , ITikEntityWithId
    {
        /// <summary>
        /// Row .id property.
        /// </summary>
        ...
        /// Row port property.
        /// </summary>
        [TikProperty("port", typeof(string), false, TikPropertyEditMode.Editable)]
        public string Port 
        { 
            get { return Properties.GetAsStringOrNull("port"); }
            set { Properties.SetPropertyValue("port", value); }
        }        	
    ...
    public sealed partial class FirewallFilterList : TikOrderedList<FirewallFilter> , IEditableTikList
    {
        /// <summary>
