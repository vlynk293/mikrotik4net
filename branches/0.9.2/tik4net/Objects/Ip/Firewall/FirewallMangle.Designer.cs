...
namespace Tik4Net.Objects.Ip.Firewall
{
    ...
    /// </summary>
    [TikEntity("/ip/firewall/mangle", TikEntityEditMode.Editable, Tik4Net.Connector.ExecuteReaderBehaviors.None)]    
    public sealed partial class FirewallMangle: TikEntityBase , ITikEntityWithId
    {
        /// <summary>
        /// Row .id property.
        /// </summary>
        ...
        /// </summary>
        [TikProperty("src-port", typeof(string), false, TikPropertyEditMode.Editable)]
        public string SrcPort 
        { 
            get { return Properties.GetAsStringOrNull("src-port"); }
    ...
    public sealed partial class FirewallMangleList : TikOrderedList<FirewallMangle> , IEditableTikList
    {
        /// <summary>
